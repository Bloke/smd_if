...
Fortunately -- and unfortunately -- it's built around "regular expressions":https://www.regular-expressions.info/ which are fiendishly powerful but can also be fiendishly tricky to learn if you are not familiar. They are worth learning.
...
bc. <txp:variable name="highest" value="100" />
...
bc. <txp:smd_if field="urlvar:comp1" operator="eq"
...
bc. <txp:smd_if field="urlvar:comp1, urlvar:comp1, urlvar:comp2"
...
bc. <txp:smd_if field="section:name, id"
     operator="begins, gt"
     value="lion, 12">
...
bc. <txp:smd_if field="summary, category1, urlvar:pic"
...
bc. <txp:smd_if field="article_image, svrvar:HTTP_USER_AGENT"
...
bc. <txp:smd_if field="parent:LVL2"
     operator="eq"
     value="mammal">
 <txp:article />
<txp:else />
...
bc. <txp:smd_if field="urlvar:pic, urlvar:page"
...
bc. <txp:smd_if field="urlvar:product_code"
     operator="isalnum">
...
bc. <txp:smd_if field="urlvar:sort_order"
     operator="in"
...
bc. <txp:smd_if field="urlvar:day, urlvar:month"
...
bc. <txp:variable name="ltuae">42</txp:variable>
